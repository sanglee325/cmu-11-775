...
def parse_args():
    ...
    # resume path
    parser.add_argument('--audio_path', default="./ckpt/audio_resnet34.pth", type=str,
                        help='path for audio model weight')
    parser.add_argument('--video_path', default="./ckpt/video_mlp.pth", type=str,
                        help='path for video model weight')
